...
import itertools
from Para_Linux import maximizar
from Smash_bros import inyectar_panel_perfiles
from auxiliar_grafica import anadir_tooltip_interactivo
from d_grafico import visualize_3d
...
def plot_gui(cycles, meta):
    ...
    # Función asesina que aniquila el proceso al darle a la X
    def cerrar_programa_por_completo():
        root.quit()
        root.destroy()
        sys.exit(0)  # Esto libera la terminal instantáneamente
    ...
    def update_molecule_plot():
        ...
        ax3.grid(True)
        anadir_tooltip_interactivo(ax3)
        canvas3.draw_idle()
    ...
    def open_compounds_window():
        ...
        panel_perfiles = ttk.Frame(new_window)
        panel_perfiles.pack(fill="x", padx=10, pady=5)
        inyectar_panel_perfiles(new_window, panel_perfiles, variables)
